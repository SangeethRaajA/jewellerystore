...
<?php
  $sql = "SELECT id,fname,lname, username, email,address, profile_picture FROM users WHERE id=?";
          ...
          <div class="col-md-8 col-md-offset-2">
            ...
            <hr>
              ...
              <br><br><br><br><br><br><br>
                    <div class="form-group <?php echo isset($errors['fname']) ? 'has-error' : '' ?>">
                <label class="control-label">First name</label>
                <input type="text" name="fname" value="<?php echo $fname; ?>" class="form-control">
                <?php if (isset($errors['fname'])): ?>
                  <span class="help-block"><?php echo $errors['fname'] ?></span>
                <?php endif; ?>
              </div>

                <div class="form-group <?php echo isset($errors['lname']) ? 'has-error' : '' ?>">
                <label class="control-label">Last name</label>
                <input type="text" name="lname" value="<?php echo $lname; ?>" class="form-control">
                <?php if (isset($errors['lname'])): ?>
                  <span class="help-block"><?php echo $errors['lname'] ?></span>
                <?php endif; ?>
              </div>
