...
// ... variables declaration is up here ...
  ...
  function updateUser($user_id) {
    global $conn, $errors,$fname,$lname, $username, $role_id, $email,$address, $isEditing;
    ...
    if (count($errors) === 0) {
      ...
      $sql = "UPDATE users SET fname=?,lname=?,username=?, role_id=?, email=?,address=?, password=?, profile_picture=? WHERE id=?";
      $result = modifyRecord($sql, 'sssissssi', [$fname,$lname,$username, $role_id, $email,$address, $password, $profile_picture, $user_id]);
  ...
  function saveUser(){
    ...
    if (count($errors) === 0) {
      ...
      $sql = "INSERT INTO users SET fname=?,lname=?,username=?, role_id=?, email=?,address=?, password=?, profile_picture=?";
      $result = modifyRecord($sql, 'sssissss', [$fname,$lname,$username, $role_id, $email,$address, $password, $profile_picture]);
  ...
  function editUser($user_id){
    global $conn, $user_id, $role_id,$fname,$lname, $username, $email,$address, $isEditing, $profile_picture;
